...
JACKETT_INDEXERS_LIST: list[str] = os.environ.get(
    "JACKETT_INDEXERS",
    "aither-api,avistaz,bitsearch,bwtorrents,digitalcore,filelist,greatposterwall,hawke-uno,hdtorrents,morethantv-api,privatehd,rutracker,skipthetrailers,solidtorrents,torrentleech,torrentseeds-api",
).split(",")
