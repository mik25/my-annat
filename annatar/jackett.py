...
JACKETT_INDEXERS_LIST: list[str] = os.environ.get(
    "JACKETT_INDEXERS",
    "audiences,eztv,hdsky,isohunt2,keepfriends,kickasstorrents-ws,limetorrents,rutracker-ru,scenehd,springsunday,thepiratebay,totheglorycookie,yourbittorrent",
).split(",")
